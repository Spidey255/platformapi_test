namespace CPS.Proof.DFSExtension
{
    ...
    public class iProofServicesHubController : ControllerBase
    {
       ...
       #region Private Members
        ...
        /// of ProjectsExplorerCF Controller.
        /// </summary>
        ...
        public Response ExecuteFormLoad(Context context)
        {
            ...
            try
            {
                ...
                switch(context.PackageProcessMapId)
                {
                                     ...
                                     case "3A7935C9-D8A6-4D6E-B274-7F9D55385FBF":   var  objectFactoryProjectsExplorerCF=new ProjectsExplorerCFObjectFactory();
                                             virtualpageinstance = objectFactoryProjectsExplorerCF.GetDfsVirtualInstance
                                                        (context.ProcessActivityMapId);

                                            virtualpageinstance._objectFactory = objectFactoryProjectsExplorerCF;
                                            break;
        ...
        public string GetComboDetails(Context context)
        {
            ...
            try
            {
                 ...
                 switch(context.PackageProcessMapId)
                {
                    ...
                    case "3A7935C9-D8A6-4D6E-B274-7F9D55385FBF":   
                                             foreach (var item in context.Params)
                                             {
                                            var  objectFactoryProjectsExplorerCF=new ProjectsExplorerCFObjectFactory();
                                             combosource = objectFactoryProjectsExplorerCF.GetComboDataSource
                                                        (item.ElementName);  
                                             }
                                            break;
        ...
        public Response SaveWidgetInstanceData(Context context)
        {
            ...
            IExtElementBase elementFactory=null;
            ...
            try
            {
                ...
                switch(context.PackageProcessMapId)
                {
                                      ...
                                      case "B0EDBC7F-E6F9-4F68-92D1-C2D70DA0933A":  var   elementFactoryAssetVerification=new AssetVerificationDataElementFactory();                                            
                                            break;

                                     case "3A7935C9-D8A6-4D6E-B274-7F9D55385FBF":  var   elementFactoryProjectsExplorerCF=new ProjectsExplorerCFDataElementFactory();                                            
                                            break;
                ...
                {
                    insertQuery = elementFactory.GetInsertGridDataQuery(context.FormInstanceId, context.PackageProcessMapId, context.ProcessActivityMapId,
                        context.WidgetId,token.UMID, formjsonData);
                }
                else
                {
                    insertQuery=elementFactory.GetInsertFormDataQuery(context.FormInstanceId, context.PackageProcessMapId, context.ProcessActivityMapId,
                        context.WidgetId, token.UMID, formjsonData);
                }
