       ...
       #region Private Members
        ...
        public Response ExecuteFormLoad(Context context)
        {
            ...
            try
            {
                ...
                switch(context.PackageProcessMapId)
                {
                                      ...
                                      case "9A6BA2F8-BA9C-4B47-AA7B-3D3DBF97702F":   var  objectFactoryProjectExplorer=new ProjectExplorerObjectFactory();
                                             virtualpageinstance = objectFactoryProjectExplorer.GetDfsVirtualInstance
                                                        (context.ProcessActivityMapId);

                                            virtualpageinstance._objectFactory = objectFactoryProjectExplorer;
                                            break;
                ...
                common.UpdateGlobalVariables(token,context, ref globalVariables, ref refParams);
            ...
            catch (Exception ex)
            {
                _sysLog.ErrorFormat("Error in ExecuteFormLoad {0} {1} {2}", ex, context.SlotId,context.ControlId);
                 ...
                 if (ex.Message.Contains("Invalid Slot"))
                   {
                    return new Response { Message = "Invalid Slot" };
                   }

               return new Response { ExecutionMessage = "Request Failed", Message = string.Format("Error in  ExecuteFormLoad- {0}", ex) };
            }
            finally
            {
        ...
        public Response ExecuteMultiRequest(Context context)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new Response { ExecutionMessage = "Request Failed",Message=string.Format("Error in  ExecuteMultiRequest in Control {0} {1}", context.ControlId, ex )};                                       
        ...
        public string GetComboDetails(Context context)
        {
            ...
            try
            {
                 ...
                 switch(context.PackageProcessMapId)
                {
                    ...
                    case "9A6BA2F8-BA9C-4B47-AA7B-3D3DBF97702F":   
                                             foreach (var item in context.Params)
                                             {
                                            var  objectFactoryProjectExplorer=new ProjectExplorerObjectFactory();
                                             combosource = objectFactoryProjectExplorer.GetComboDataSource
                                                        (item.ElementName);  
                                             }
                                            break;
            ...
            {
                _sysLog.Error("Error in GetComboDetails", ex);

                 if (ex.Message.Contains("Invalid Slot"))
                   {
                    var response = new Response { Message = "Invalid Slot" };
        ...
        public Response SaveWidgetInstanceData(Context context)
        {
            ...
            try
            {
                ...
                switch(context.PackageProcessMapId)
                {
                                      ...
                                      case "9A6BA2F8-BA9C-4B47-AA7B-3D3DBF97702F":    var elementFactoryProjectExplorer=new ProjectExplorerDataElementFactory();       
                                           
                                             if(context.Action=="GridSave")
                                            {
                                                insertQuery = elementFactoryProjectExplorer.GetInsertGridDataQuery(context.FormInstanceId, context.PackageProcessMapId, context.ProcessActivityMapId,
                                                    context.WidgetId,token.UMID, formjsonData);
                                            }
                                            else
                                            {
                                                insertQuery=elementFactoryProjectExplorer.GetInsertFormDataQuery(context.FormInstanceId, context.PackageProcessMapId, context.ProcessActivityMapId,
                                                    context.WidgetId, token.UMID, formjsonData);
                                            }
                ...
                var status = externalQueryController.
                    SaveFormInstanceData(token,insertQuery);
            ...
            {
                _sysLog.Error("Error in  SaveWidgetInstanceData",ex);
        ...
        public Response GetFormInstanceData(Context context)
        {
         ...
         [HttpPost]
        [Route("DeleteGridInstanceData")]
        public Response DeleteGridInstanceData(Context context)
        {
            ...
            try
            {
                ...
                var status = externalQueryController.
                    DeleteGridInstanceData(context);

                if(status == Status.Success)
                {
                    return new Response { Message = "Rows Deleted Successfully" };
                }

                return new Response { Message = "Delete Failed" };
            }
            catch (Exception ex)
            {
