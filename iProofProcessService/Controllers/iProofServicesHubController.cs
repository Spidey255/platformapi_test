namespace CPS.Proof.DFSExtension
{
    ...
    public class iProofServicesHubController : ControllerBase
    {
       ...
       #region Private Members
        ...
        /// of TaskFunctionalTesting Controller.
        /// </summary>
        ...
        public Response ExecuteFormLoad(Context context)
        {
            ...
            try
            {
                ...
                switch(context.PackageProcessMapId)
                {
                                      ...
                                      case "74bf8517-74c6-4b98-970f-0ad595b13f64":   var  objectFactoryTaskFunctionalTesting=new TaskFunctionalTestingObjectFactory();
                                             virtualpageinstance = objectFactoryTaskFunctionalTesting.GetDfsVirtualInstance
                                                        (context.ProcessActivityMapId);

                                            virtualpageinstance._objectFactory = objectFactoryTaskFunctionalTesting;
                                            break;
        ...
        public string GetComboDetails(Context context)
        {
            ...
            try
            {
                 ...
                 switch(context.PackageProcessMapId)
                {
                    ...
                    case "74bf8517-74c6-4b98-970f-0ad595b13f64":   
                                             foreach (var item in context.Params)
                                             {
                                            var  objectFactoryTaskFunctionalTesting=new TaskFunctionalTestingObjectFactory();
                                             combosource = objectFactoryTaskFunctionalTesting.GetComboDataSource
                                                        (item.ElementName);  
                                             }
                                            break;
        ...
        public Response SaveWidgetInstanceData(Context context)
        {
            ...
            try
            {
                ...
                switch(context.PackageProcessMapId)
                {
                                      ...
                                      case "74bf8517-74c6-4b98-970f-0ad595b13f64":  var   elementFactoryTaskFunctionalTesting=new TaskFunctionalTestingDataElementFactory();                                            
                                            break;
