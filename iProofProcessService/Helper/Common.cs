...
namespace CPS.Proof.DFSExtension
{
    public class Common:ICommon
    {
        ...
        private string _ProcessMapId=null;

        private string _SlotId=null;

        private ILog _sysLog = null;
        ...
        /// </param>
         /// <param name="isStaySignedIn" cref="string">
        /// holds the IsStaySignedIn Detail
        /// </param>
        /// <returns>
        /// returns SlotToken
        /// </returns>
        ...
        public void UpdateGlobalVariables( SlotToken token,Context context,
            ...
            foreach (var data in keyList)
            {
                switch (data)
                {
                    ...
                    case "gv_processmapid":
                        globalVariables[data] = context.PackageProcessMapId;
                        break;
                    ...
                    case "gv_activitymapid":
                        globalVariables[data] = context.ProcessActivityMapId;
                        break;

                    case "gv_formversion":
                        globalVariables[data] = context.FormVersionId;
                        break;

                    case "gv_instanceid":
                        globalVariables[data] = context.FormInstanceId;
                        break;
                    ...
                    case "gv_tenantid":
                        globalVariables[data] = token.TenId;
                        break;
