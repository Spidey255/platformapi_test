...
namespace CPS.Proof.DFSExtension
{
    ...
    public abstract class VirtualForm : IVirtualPage
    {
        ...
        public IExtElementBase ElementFactory { get; set; }
        ...
        /// </summary>
        /// <param name="action">
        /// A <see cref="string"/> that holds action name.
        /// </param>
        /// <param name="element">
        /// A <see cref="string"/> that holds Element Name.
        /// </param>
        /// <param name="dfsparams">
        /// A <see cref="Dictionary{String, Object}"/> that holds Element Name.
        /// </param>
        ...
        /// </summary>
        /// <param name="utcDate">A<see cref="System.DateTime"/>
        /// holds the utcdate</param>
        /// <param name="timeZone">A<see cref="string"/>
               ...
               (string expressionId, string query, bool? isLookup)
        {
            ...
            _log.Debug("Entering  ExecuteQuery");
            ...
            (string instanceId, string widgetId)
        {
            ...
            {
                _log.Error("Error in GetElementClientData", ex);
        ...
        {
            _log.Debug("Entering  SetGridDataSource");
            ...
            {
                _log.Error("Error in SetGridDataSource",ex);
            ...
            finally
            {
                ...
                _log.Debug("Exiting SetGridDataSource");
            ...
            List<Triplet<string, short, short?>> bindings,string elementId, ref Dictionary<string, ServiceElementData> ISpace)
        {
            ...
            {
            _log.Error("Entering SetGridData",ex);
