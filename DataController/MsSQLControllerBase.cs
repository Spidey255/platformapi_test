...
namespace CPS.Proof.DFSExtension
{
    public class MsSQLControllerBase
    {
        ...
        {        
            ...
            try
            {
                var repConnection = AppParams.GetAppSettings("RepConnectionName");

                var proofConnection = AppParams.GetAppSettings("ProofConnectionName");
        ...
        /// The <see cref="Database"/>instance.
        /// </returns>
        protected Database GetProofInstance()
        {

            var repConnectionName = AppParams.GetAppSettings("RepConnectionName");

            var proofConnectionName = AppParams.GetAppSettings("ProofConnectionName");
            ...
            try
            {
                ...
                var connectionString = GetConnectionStringById
                        (repConnectionName, proofConnectionName);
